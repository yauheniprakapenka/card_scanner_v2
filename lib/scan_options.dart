...
class ScanOptions {
  ...
  ///defaults to [CardHolderPosition.belowCardNumber]
  final List<CardHolderPosition> possibleCardHolderNamePositions;
  ...
  Map<String, String> get map {
    ...
    if (possibleCardHolderNamePositions
        .contains(CardHolderPosition.belowCardNumber))
      possibleNamePositions.add('belowCardNumber');
    if (possibleCardHolderNamePositions
        .contains(CardHolderPosition.aboveCardNumber))
